...
export default R => {
    ...
    function extractStyle(node) {
        return {
            font: {
                family:
                    typeof node.attrs.font === 'undefined'
                        ? null
                        : node.attrs.font.replace(/^.?"(\w+)".$/, '$1'),
                size:
                    typeof node.attrs['font-size'] === 'undefined'
                        ? null
                        : parseInt(node.attrs['font-size']),
                style:
                    typeof node.attrs['font-style'] === 'undefined'
                        ? null
                        : node.attrs['font-style'],
                weight:
                    typeof node.attrs['font-weight'] === 'undefined'
                        ? null
                        : node.attrs['font-weight']
            },
            anchor:
                typeof node.attrs['text-anchor'] === 'undefined'
                    ? null
    ...
    var serializer = {
        ...
        path: function(node) {
            var initial =
                node.matrix.a === 1 && node.matrix.d === 1
                    ? {}
    ...
    R.fn.toSVG = function() {
        var paper = this,
            ...
            svg =
                '<svg style="overflow: hidden; position: relative;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="' +
                paper.width +
                '" version="1.1" height="' +
                paper.height +
                '">';
